...
// get publically availably user information such as username based on id - /api/users/:id
...
// register a new user - /api/users/new
router.post("/new", async (req, res) => {
  try {
    ...
    if (req.body.password !== null && userName !== null && email !== null) {
      ...
      // check if userName is unique, if not unique do not proceed with registration
